<template>
  <q-page class="q-mx-sm" dir="rtl">
    ...
    <q-form @submit.prevent="changeUserName" class="q-my-md">
      ...
      <!-- //////////// -->
      <div class="q-my-md">
        <div class="text-right text-500 q-mx-sm">رقم الجوال</div>
        <q-input
          v-model="main_munber"
          filled
          dense
      ...
      <!-- //////*////////// -->
      <div class="q-my-md">
        <div class="text-right text-500 q-mx-sm">رقم الجوال اضافي</div>
        <q-input
          v-model="other_munber"
          filled
          dense
          rounded
          class="input"
      ...
      <!-- //////// -->
      <div class="q-my-md">
        <div class="text-right text-500 q-mx-sm">كلمة المرور</div>
        <q-input
          filled
          dense
          rounded
